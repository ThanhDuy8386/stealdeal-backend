...
namespace StealDeal.Services.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260818054548_AddIdentityProcessedMessages")]
    partial class AddIdentityProcessedMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StealDeal.Services.Identity.Domain.Models.Admin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AdminRole", b =>
                {
                    b.HasOne("StealDeal.Services.Identity.Domain.Models.Admin", null)
                        .WithMany()
